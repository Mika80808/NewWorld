...
- [x] 任務失敗機制
  2026-03-30 [Claude Code]: 新增 PendingQuestFailure 型別，timeUtils 回傳 newFailures，commandReducer/useCommandParser 串接，pendingQuestFailures 存入 GameSaveData（schema v3 + migration），buildPrompt 注入逾期通知區塊，App.tsx 消費後清除
